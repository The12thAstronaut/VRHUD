...
public class gesture_PLANES_TEST : MonoBehaviour
{
   //public Camera cam;
    ...
    void Update()
    {
        ...
        if (Trigger_U.GetComponent<Renderer>().material.color == Color.yellow)
        {
            TriggerActive_U = true;
            timeStart = 0;
        }

        if (Trigger_D.GetComponent<Renderer>().material.color == Color.yellow)
        {
